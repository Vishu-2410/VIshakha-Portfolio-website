            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <h1>{`Hi! I'm Vishakha Mourya`}<br /> <span className="txt-rotate" dataPeriod="1000" data-rotate='["Full Stack Developer", "Web Developer", "Frontend Developer","UI/UX Designer" ]'><span className="wrap">{text}</span></span></h1>
                  <p>As a Full Stack Developer, I have a diverse skill set that enables me to design, develop, and deploy end-to-end
                    web applications. With a passion for problem-solving and an eye for detail, I am dedicated to delivering highquality,
